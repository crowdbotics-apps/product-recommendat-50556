"""product_recommendat_50556 URL Configuration
...
admin.site.site_title = "Product Recommendation Admin Portal"
admin.site.index_title = "Product Recommendation Admin"
